...
# Purpose: Defines the TCP metrics to be collected, including:
# sent_bytes: Bytes sent over TCP.
# nfast_retrans: Number of fast retransmissions.
# ntimeouts: Number of TCP retransmission timeouts.
# cwin: Congestion window size.
# sample_rtt: Sample round-trip time.
# cur_send_queue: Current size of the send queue.
# rwin: Receiver window size.
# sum_rtt: Sum of RTT values.
# max_send_queue: Maximum send queue size observed
